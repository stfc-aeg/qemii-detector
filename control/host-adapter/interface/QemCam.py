...
class QemCam(object):
    ...
    def connect(self):
        ...
        self.x10g_stream = ImageStreamUDP(self.server_data_ip_addr, 61650, self.server_data_ip_addr,61651, self.camera_data_ip_addr, 61650, self.camera_data_ip_addr,61651,1*1000**3,9000,20)
    ...
    def display_image_stream(self, num_images):
        ...
        while image_count <= num_images :
            ...
            cv2.imshow('image',sensor_image << 5)
    ...
    def log_image_stream2(self, file_name, num_images):
        #get the image set
        image_set = self.x10g_stream.get_image_set(num_images)
        #write to hdf5 file
        file_name = file_name + '.h5'
    ...
    def set_10g_mtu(self,core_num, new_mtu):
        ...
        if core_num == 'data':
            ...
            self.x10g_stream.image_mtu = new_mtu
        elif core_num =='control':
