...
namespace Qemii {
    ...
    static const size_t num_of_fems = 1;
    static const size_t max_data_per_fem = 6; //changed to 2 from 6 for debug tests
    static const size_t data_height_per_10g = 176;
    static const size_t total_max_streams = num_of_fems * max_data_per_fem; //max_num_fems * max_data_per_fem;
    static const size_t const_max_frame_size = (packet_size * num_frame_packets) * total_max_streams;
    ...
    static const int32_t default_frame_number = -1; //why is this -1: need to investigate AOD
    const std::string CONFIG_FEM_PORT_MAP = "fem_port_map";
    static const uint16_t qemii_image_width = 4104;
    static const uint16_t qemii_image_height = data_height_per_10g * max_data_per_fem;
